...
modDatetime: *id001
title: "Java中的注解详解及其应用"
slug: "java-annotations-and-usage"
featured: false
draft: false
tags:
- JavaWeb
description: Java注解是一种元数据机制，可用于编写文档、代码分析和编译检查。本文介绍了JDK内置注解、自定义注解及其属性和元注解的使用方法，并通过示例展示了如何在程序中解析注解。
---
...
**编译与反编译的过程**
![注解的本质](https://raw.githubusercontent.com/YarrowRen/FileBackup/refs/heads/master/blog_img/%E6%B3%A8%E8%A7%A3%E7%9A%84%E6%9C%AC%E8%B4%A8.jpg)
...
#### 调用注解并获取属性值
```java
@Pro(className = "com.boyuren.domain.Person",methodName = "MessageOfPerson")
