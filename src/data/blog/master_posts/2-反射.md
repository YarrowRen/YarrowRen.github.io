...
modDatetime: *id001
title: "Java反射机制详解及其应用"
slug: "java-reflection-and-applications"
featured: false
draft: false
tags:
- JavaWeb
description: 探讨Java反射机制在框架设计中的应用，包括反射的优点、Java代码的运行阶段及获取Class对象的方法，详细讲解如何利用Class对象访问类的成员变量、构造方法和成员方法。
---
...
## Java代码在计算机中的三个运行阶段
![java代码三个运行阶段](https://raw.githubusercontent.com/YarrowRen/FileBackup/refs/heads/master/blog_img/java%E4%BB%A3%E7%A0%81%E4%B8%89%E4%B8%AA%E8%BF%90%E8%A1%8C%E9%98%B6%E6%AE%B5.jpg)
...
public class ReflectDemo1 {
    ...
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        //Class.forName("全类名")
        Class cls1=Class.forName("com.boyuren.domain.Person");
...
/* 运行结果
public int com.boyuren.domain.Person.num
--------------------
80
--------------------
private java.lang.String com.boyuren.domain.Person.name
private int com.boyuren.domain.Person.age
public int com.boyuren.domain.Person.num
--------------------
boyuren
*/
...
public class ReflectDemo3 {
    public static void main(String[] args) throws Exception {
        ...
        Object person=constructor.newInstance("boyuren",19,95);
...
/* 运行结果
Person{name='boyuren', age=19, num=95}
...
public class ReflectDemo4 {
    public static void main(String[] args) throws Exception {
        ...
        //执行方法
        Person person = new Person("boyuren", 19, 95);
...
/*
name is boyuren, age is 19, num is 95
name is boyuren, age is 19, num is 95
name is boyuren, age is 19, num is 95
name is boyuren, age is 19, num is 95
name is boyuren, age is 19, num is 95
...
```properties
className=com.boyuren.domain.Person
