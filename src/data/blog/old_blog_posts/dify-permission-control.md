...
| ----------------------------- | ----------- | ----------- | --------------- | -------- | ------- | ---------- |
| **所有者 (Owner)**               | 全部权限     | 创建/编辑/删除 | 创建/编辑/删除     | 完整权限  | 完整配置 | 全部权限    |
| **管理员 (Admin)**               | 添加普通成员/编辑 | 创建/编辑/删除 | 创建/编辑/删除     | 无权限    | 部分权限 | 全部权限    |
| **编辑者 (Editor)**              | 无         | 创建/编辑    | 创建/编辑        | 无权限    | 无     | 协作使用    |
| **普通成员 (Normal)**             | 无         | 无         | 无             | 无权限    | 无     | 使用      |
| **Dataset Operator** | 无         | 无         | 查询/上传/标注 | 无权限    | 无     | 无（除数据集外） |
